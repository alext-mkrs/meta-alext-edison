...
# The above is how it *should* be done, but Edison's distro lacks "bluez5" entry and I don't want to drag bluez4 dependency in
BLUEZ ?= "bluez5"
...
# Edison distro has bluez5, let's add it
PACKAGECONFIG[bluez5] = "bluez='true',bluez='false',bluez5"
